...
To use these stylesheets, rename the files and dallas-show with the name of your theme.
...
dallas-show-alpha-default-narrow.css
...
dallas-show-alpha-default-normal.css
...
dallas-show-alpha-default-wide.css
