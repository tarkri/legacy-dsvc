 ...
 * @see html.tpl.php
 */
function dallas_show_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'dallas_show');
 ...
 */
function dallas_show_css_alter(&$css) {
  global $language;
 ...
 * Preprocess field.
 */
function dallas_show_preprocess_field(&$variables) {
...
function dallas_show_preprocess_node(&$variables) {
